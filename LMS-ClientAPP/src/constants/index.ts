...
export const DQ_IMG =
  "https://res.cloudinary.com/dopsga5zr/image/upload/fl_preserve_transparency/v1728363050/DQ_doggxn.jpg?_s=public-apps";
export const sensei_prof_pic_default =
